...
const translations = {
  "Chinese": {
    ...
    "secondLLMApiKeyLabel": "僅支援 Claude Key (用於 claude-3-5-sonnet):",
  ...
  "Japanese": {
    ...
    "secondLLMApiKeyLabel": "Claude Keyのみ対応 (claude-3-5-sonnet用):",
  ...
  "English": {
    ...
    "secondLLMApiKeyLabel": "Claude Key only (for claude-3-5-sonnet):",
